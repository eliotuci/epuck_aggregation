  ...
  : QWidget(parent)
{
  ...
  pathDirImages = "/home/elt7/Simulations/dynaSim/RENDERING/";
}
...
void Interface::createButtons()
{
  ...
  openButton->setIcon(QIcon("/home/elt7/Simulations/dynaSim/RENDERING/IMAGES/open.png"));
...
//   connect(reset_eval_loopButton, SIGNAL(clicked()), this, SLOT(active_reset_eval_loop()));
  ...
  playButton->setIcon(QIcon("/home/elt7/Simulations/dynaSim/RENDERING/IMAGES/play.png"));
  ...
  oneStepButton->setIcon(QIcon("/home/elt7/Simulations/dynaSim/RENDERING/IMAGES/oneStep.png"));
  ...
  pauseButton->setIcon(QIcon("/home/elt7/Simulations/dynaSim/RENDERING/IMAGES/pause.png"));
  pauseButton->setIconSize(iconSize);
  pauseButton->setToolTip(tr("Pause"));
  connect(pauseButton, SIGNAL(clicked(bool)), this, SLOT(active_pause()));
  
  stopButton = new QToolButton;
  stopButton->setIcon(QIcon("/home/elt7/Simulations/dynaSim/RENDERING/IMAGES/stop.png"));
  stopButton->setIconSize(iconSize);
  stopButton->setToolTip(tr("Stop"));
  connect(stopButton, SIGNAL(clicked()), this, SLOT(active_stop()));
  
  quitButton = new QToolButton;
  quitButton->setIcon(QIcon("/home/elt7/Simulations/dynaSim/RENDERING/IMAGES/quit.png"));
  quitButton->setIconSize(iconSize);
  quitButton->setToolTip(tr("Quit"));
  connect(quitButton, SIGNAL(clicked()), this, SLOT(active_quit()));
  
  recButton = new QToolButton;
  recButton->setIcon(QIcon("/home/elt7/Simulations/dynaSim/RENDERING/IMAGES/rec.png"));
  ...
  stopRecButton->setIcon(QIcon("/home/elt7/Simulations/dynaSim/RENDERING/IMAGES/stop.png"));
...
{
  setWindowTitle(windowTitle + " - Evaluation : " + QString::number( exp->getEvaluation() )
		 // + " - Iter : " + QString::number( exp->getIteration() )
		 );
}
